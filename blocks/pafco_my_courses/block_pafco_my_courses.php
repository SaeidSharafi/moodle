...
require_once($CFG->dirroot. '/theme/pafco/ccn/block_handler/ccn_block_handler.php');
class block_pafco_my_courses extends block_base {

    public function init() {
        $this->title = get_string('pluginname', 'block_pafco_my_courses');
    }
...
';
    ...
    public function html_attributes() {
      ...
      include($CFG->dirroot . '/theme/pafco/ccn/block_handler/attributes.php');
      return $attributes;
    }
