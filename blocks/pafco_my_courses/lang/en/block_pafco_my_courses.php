...
$string['pafco_my_courses:addinstance'] = 'Add a [pafco] My Courses block';
$string['pafco_my_courses:myaddinstance'] = 'Add a [pafco] My Courses block to my moodle';
$string['pluginname'] = '[pafco] My Courses';
$string['pafco_my_courses'] = '[pafco] My Courses';
