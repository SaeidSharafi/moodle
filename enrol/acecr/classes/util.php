...
/**
 * AcecrPayment enrolment plugin utility class.
 *
 * @package    enrol_acecr
...
final class util {
     ...
     * @param stdClass $data    AcecrPayment IPN data
     */
    public static function message_acecr_error_to_admin($subject, $data) {
        $admin = get_admin();
        $site = get_site();
