...
$string['footerbtitle2default'] = 'پیوندها';
$string['footerbtitle3default'] = 'شبکه‌های اجتماعی';
$string['footerbtitle4default'] = 'تماس با ما';
...
$string['text'] = 'Text';
$string['icon'] = 'Icon';
$string['loginheader'] = 'لطفا وارد حساب کاربری خود شوید';
...
$string['footeremail'] = 'پست الکترونیک:';
...
$string['phone'] = "تلفن";
$string['courselist'] = "لیست دوره ها";

$string['contactteacher'] = 'ارتباط با اساتید';
$string['mycourses'] = 'لیست دوره ها';
