...
/**
 * Strings for component 'theme_egkuro', language 'en'
 *
...
$string['pluginname'] = 'EG Kuro';
$string['address'] = 'Address';
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot">
<img class=img-polaroid src="egkuro/pix/screenshot.jpg" />
<h3>Theme Credits</h3>
<p>
<h3>Moodle EG Kuro theme</h3>
<p> This theme is based on the Egkuro and Boost based Moodle theme. </p>
<p>Authors: Saeid SHarafi<br>
Contact: info@jdqazvin.ir<br>
<br> </p>';
$string['configtitle'] = 'Eg Kuro';
$string['connectus'] = 'Connect with us';
$string['contact'] = 'Contact';
$string['customcss'] = 'Custom CSS';
$string['customcssdesc'] = 'Whatever CSS rules you add to this textarea will be reflected in every page, making for easier customization of this theme.';
$string['defaultaddress'] = '308 پافکو  تهران - خیابان مطهری - بعد از سهروردی - پلاک 84 - واحد ';
...
$string['dark_purple'] = "Dark Purple";
$string['green'] = "Green";
$string['blue'] = "Blue";
...
$string['phone'] = "Phone";
$string['courselist'] = "Courses list";

$string['banner']='Login banner';
$string['bannerdesc']='Please upload your custom login banner here if you want to add it to the login page. ';
$string['flatnavheading']='Navigation Settings';
$string['removenavheading']='Customize navigations';
$string['customizenav']='Items to remove';
$string['customizenav_desc']='Add each item in a line with pattern ROLE|&lt;item key&gt;
<pre>
Roles : (REG,GUEST,ADMIN,TEACHER,STUDENT)
Example:
REG|home
</pre>';
$string['addnav']='Items to Add';
$string['addnav_desc']='Add each item in a line with pattern ROLE|&lt;title&gt;|url
<pre>
Roles : (REG,GUEST,ADMIN,TEACHER,STUDENT)
Example:
REG|About us|http://example.com/aboutus
</pre>';


$string['customizenavdefault'] = ' ';
$string['addnavdefault'] = '';

$string['contactteacher'] = 'Contact Teacher';
$string['mycourses'] = 'Courses list';
