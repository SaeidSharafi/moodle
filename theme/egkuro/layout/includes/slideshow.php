...
function slideshow() {
    ...
    $numberofslides = theme_egkuro_get_setting('numberofslides');
    $slideimage = '';
    $visableslide = 0;

    for ($s1 = 1; $s1 <= $numberofslides; $s1++) {
        $slideimage .= theme_egkuro_render_slideimg($s1, 'slide' . $s1 . 'image');
    }
    ...
    if ($slideimage) {
        ...
        if ($numberofslides) {
            ...
            for ($s1 = 1; $s1 <= $numberofslides; $s1++):
                $slidecaption = theme_egkuro_get_setting('slide'.$s1.'caption', true);
                $slidecaption = theme_egkuro_lang($slidecaption);
                $slideimg = theme_egkuro_render_slideimg($s1, 'slide' . $s1 . 'image');
                if (empty($slideimg)) {
                    $slideimg = '';
                }
                $slidebtn = theme_egkuro_get_setting('slide'.$s1.'urltext');
                $slidebtn = theme_egkuro_lang($slidebtn);
                $slidebtnurl = theme_egkuro_get_setting('slide' . $s1 . 'url');
                $icon = "fa-angle-right";
                if (right_to_left()) {
                    $icon = "fa-angle-left";
                }
