...
function egkuro_marketingspot() {
    ...
    for ($i = 1; $i <= 4; $i++) {
        $mspicon = theme_egkuro_get_setting('mspot'.$i.'icon');
        $msptitle = theme_egkuro_get_setting('mspot'.$i.'title');
        $mspdescription = theme_egkuro_get_setting('mspot'.$i.'desc');
    ...
    for ($i = 1; $i <= 4; $i++) {
        $mspicon = theme_egkuro_get_setting('mspot'.$i.'icon');
        $msptitle = theme_egkuro_get_setting('mspot'.$i.'title');
        $msptitle = theme_egkuro_lang($msptitle);
        $mspdescription = theme_egkuro_get_setting('mspot'.$i.'desc');
        $mspdescription = theme_egkuro_lang($mspdescription);
