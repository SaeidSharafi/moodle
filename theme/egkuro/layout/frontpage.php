...
global $OUTPUT, $PAGE;
$html = theme_egkuro_get_html_for_settings($OUTPUT, $PAGE);
...
?>
<body <?php echo $OUTPUT->body_attributes($extraclasses); ?>>
...
<link rel="stylesheet" href="<?php echo theme_egkuro_theme_url(); ?>/style/slick.css" />

<?php
if(!isloggedin() || isguestuser()) {
    $toggleslideshow = theme_egkuro_get_setting('toggleslideshow');
...
<div id="page" class="container">
 ...
 <script src="<?php echo theme_egkuro_theme_url(); ?>/javascript/slick.js"></script>
<script>
$( function() {
