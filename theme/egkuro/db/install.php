...
/**
 * Theme_egkuro install function.
 *
 * @return void
 */

function xmldb_theme_egkuro_install() {
    global $CFG;
    ...
    // Slider images.
        ...
        $filerecord->component = 'theme_egkuro';
        ...
        $fs->create_file_from_pathname($filerecord, $CFG->dirroot . '/theme/egkuro/pix/home/slide1.jpg');
}
