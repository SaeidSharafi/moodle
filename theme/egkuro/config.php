 ...
 * @copyright   2020 saeid_sharafi12@yahoo.com
 * @author      Saeid sharafi
...
$THEME->csstreepostprocessor = 'theme_egkuro_css_tree_post_processor';

$no = get_config('theme_egkuro', 'patternselect'); // Selected theme pattern no returned.
...
$THEME->csspostprocess = 'theme_egkuro_process_css';
$THEME->scss = function($theme) {
    ...
    return theme_egkuro_get_main_scss_content($parentconfig);
};
