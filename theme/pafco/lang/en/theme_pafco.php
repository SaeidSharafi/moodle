...
$string['configtitle'] = 'Pafco settings';
$string['choosereadme'] = 'Pafco Premium Moodle Theme, Created by Pafco.';
...
$string['pafco_block_settings'] = '[Pafco] Advanced block settings';
$string['pafco_carousel_settings'] = '[Pafco] Slider settings';
...
$string['block_styles'] = '[Pafco] Block styles';
...
$string['pafco_facebook_url'] = 'Facebook URL';
$string['pafco_facebook_url_desc'] = 'The link to your company\'s Facebook profile.';
$string['pafco_twitter_url'] = 'Twitter URL';
$string['pafco_twitter_url_desc'] = 'The link to your company\'s Twitter profile.';
$string['pafco_instagram_url'] = 'Instagram URL';
$string['pafco_instagram_url_desc'] = 'The link to your company\'s Instagram profile.';
$string['pafco_dribbble_url'] = 'Dribbble URL';
$string['pafco_dribbble_url_desc'] = 'The link to your company\'s Dribbble profile.';
$string['pafco_pinterest_url'] = 'Pinterest URL';
$string['pafco_pinterest_url_desc'] = 'The link to your company\'s Pinterest profile.';
$string['pafco_google_url'] = 'Google URL';
$string['pafco_google_url_desc'] = 'The link to your company\'s Google profile.';
$string['pafco_youtube_url'] = 'YouTube URL';
$string['pafco_youtube_url_desc'] = 'The link to your company\'s YouTube profile.';
$string['pafco_vk_url'] = 'VK URL';
$string['pafco_vk_url_desc'] = 'The link to your company\'s VK profile.';
$string['pafco_500px_url'] = '500px URL';
$string['pafco_500px_url_desc'] = 'The link to your company\'s 500px profile.';
$string['pafco_behance_url'] = 'Behance URL';
$string['pafco_behance_url_desc'] = 'The link to your company\'s Behance profile.';
$string['pafco_digg_url'] = 'Digg URL';
$string['pafco_digg_url_desc'] = 'The link to your company\'s Digg profile.';
$string['pafco_flickr_url'] = 'Flickr URL';
$string['pafco_flickr_url_desc'] = 'The link to your company\'s Flickr profile.';
$string['pafco_foursquare_url'] = 'Foursquare URL';
$string['pafco_foursquare_url_desc'] = 'The link to your company\'s Foursquare profile.';
$string['pafco_linkedin_url'] = 'LinkedIn URL';
$string['pafco_linkedin_url_desc'] = 'The link to your company\'s LinkedIn profile.';
$string['pafco_medium_url'] = 'Medium URL';
$string['pafco_medium_url_desc'] = 'The link to your company\'s Medium profile.';
$string['pafco_meetup_url'] = 'Meetup URL';
$string['pafco_meetup_url_desc'] = 'The link to your company\'s Meetup profile.';
$string['pafco_snapchat_url'] = 'Snapchat URL';
$string['pafco_snapchat_url_desc'] = 'The link to your company\'s Snapchat profile.';
$string['pafco_tumblr_url'] = 'Tumblr URL';
$string['pafco_tumblr_url_desc'] = 'The link to your company\'s Tumblr profile.';
$string['pafco_vimeo_url'] = 'Vimeo URL';
$string['pafco_vimeo_url_desc'] = 'The link to your company\'s Vimeo profile.';
$string['pafco_wechat_url'] = 'WeChat URL';
$string['pafco_wechat_url_desc'] = 'The link to your company\'s WeChat profile.';
$string['pafco_whatsapp_url'] = 'WhatsApp URL';
$string['pafco_whatsapp_url_desc'] = 'The link to your company\'s WhatsApp profile.';
$string['pafco_wordpress_url'] = 'WordPress URL';
$string['pafco_wordpress_url_desc'] = 'The link to your company\'s WordPress profile.';
$string['pafco_weibo_url'] = 'Weibo URL';
$string['pafco_weibo_url_desc'] = 'The link to your company\'s Weibo profile.';
$string['pafco_telegram_url'] = 'Telegram URL';
$string['pafco_telegram_url_desc'] = 'The link to your company\'s Telegram profile.';
$string['pafco_moodle_url'] = 'Moodle URL';
$string['pafco_moodle_url_desc'] = 'The link to your company\'s Moodle profile.';
$string['pafco_amazon_url'] = 'Amazon URL';
$string['pafco_amazon_url_desc'] = 'The link to your company\'s Amazon profile.';
$string['pafco_slideshare_url'] = 'SlideShare URL';
$string['pafco_slideshare_url_desc'] = 'The link to your company\'s SlideShare profile.';
$string['pafco_soundcloud_url'] = 'Soundcloud URL';
$string['pafco_soundcloud_url_desc'] = 'The link to your company\'s Soundcloud profile.';
$string['pafco_leanpub_url'] = 'Leanpub URL';
$string['pafco_leanpub_url_desc'] = 'The link to your company\'s Leanpub profile.';
$string['pafco_xing_url'] = 'Xing URL';
$string['pafco_xing_url_desc'] = 'The link to your company\'s Xing profile.';
$string['pafco_bitcoin_url'] = 'Bitcoin URL';
$string['pafco_bitcoin_url_desc'] = 'The link to your company\'s Bitcoin profile.';
$string['pafco_twitch_url'] = 'Twitch URL';
$string['pafco_twitch_url_desc'] = 'The link to your company\'s Twitch profile.';
$string['pafco_github_url'] = 'Github URL';
$string['pafco_github_url_desc'] = 'The link to your company\'s Github profile.';
$string['pafco_gitlab_url'] = 'Gitlab URL';
$string['pafco_gitlab_url_desc'] = 'The link to your company\'s Gitlab profile.';
$string['pafco_forumbee_url'] = 'Forumbee URL';
$string['pafco_forumbee_url_desc'] = 'The link to your company\'s Forumbee profile.';
$string['pafco_trello_url'] = 'Trello URL';
$string['pafco_trello_url_desc'] = 'The link to your company\'s Trello profile.';
$string['pafco_weixin_url'] = 'Weixin URL';
$string['pafco_weixin_url_desc'] = 'The link to your company\'s Weixin profile.';
$string['pafco_slack_url'] = 'Slack URL';
$string['pafco_slack_url_desc'] = 'The link to your company\'s Slack profile.';
...
$string['lazy_loading_desc'] = 'Lazy loading speeds up your website by only loading images once they scroll into view. Pafco 2.5 and above introduces experimental lazy loading in some areas of your Moodle website.';
...
$string['color_side_menu'] = 'Side menu Background Color';
...
$string['blog_post_author_desc'] = 'Show or hide the author name on blog posts. This setting controls the blog listing page, individual blog posts, and all [Pafco] blocks.';
$string['blog_post_date'] = 'Blog post date';
$string['blog_post_date_desc'] = 'Show or hide the date on blog posts. This setting controls the blog listing page, individual blog posts, and all [Pafco] blocks.';
...
$string['pafco_homepage'] = 'Frontpage';
$string['pafco_homepage_desc'] = 'Settings for the frontpage layout';
$string['pafco_homepage_core'] = 'Frontpage sections';
$string['pafco_homepage_core_desc'] = 'Display Moodle core sections on the frontpage?';
$string['login_layout_desc'] = 'The layout that is used for login and registration pages.';
$string['layout_settings'] = 'Layout';
$string['pafco_focus'] = 'Pafco Focus';
$string['pafco_focus_desc'] = 'Settings for Pafco Focus layouts.';
$string['pafco_focus_sidebar'] = 'Display navigation sidebar?';
$string['pafco_focus_sidebar_desc'] = 'Choose whether to display the activity sidebar in Pafco Focus layouts.';
...
$string['icons'] = 'Icons';
$string['icons_desc'] = 'Pafco includes 4 iconsets that provide a total of 3000 icons. If you prefer less icons, disable iconsets here. Before disabling iconsets, please make sure that no fields are using icons from the disabled sets.';
$string['iconset_desc'] = 'Load this iconset';
$string['iconset_pafco'] = 'Pafco icons';
$string['iconset_pafco'] = 'Pafco icons';
...
$string['for_developers_desc'] = 'Settings provided for developers to aid in further extension of Pafco theme.';
$string['dev_expose_blocks'] = 'Expose blocks';
$string['dev_expose_blocks_desc'] = 'Make all custom Pafco blocks available on all site pages, including the user dashboard and site administration.';
...
$string['logo_url_desc'] = 'Override the logo URL in all Pafco headers and footers.';
...
$string['showmoodlefirstpage'] = 'Show Moddle first page items';
$string['showmoodlefirstpagedesc'] = 'If enabled, display the items that are selected in "First page setting" section';

$string['frontpage_settings'] = 'Front Page';
$string['videoposter'] = 'Video poster';
$string['videoposter_desc'] = 'Video poster for front page video';
...
$string['contactus_settings'] = 'Contact Us';
$string['contactus_html'] = 'Contact us text';
$string['contact_support_default'] = '
<div class="w-100">
...
<div id="support" class="mt-3 text-justify" style="line-height: 1.75rem; font-size: 14px;">
    ...
    <p>
        <br>
        Greetings to the esteemed professors, students, and learners of 
        <strong>Intelligent Medical Sciences University</strong>.
    </p>
    <p style="text-align:justify;">
        To reach the admin of the Navid system at 
        <strong>Intelligent Medical Sciences University</strong>, 
        please contact us during business hours at the five-digit phone number 
        <strong>41134</strong> 
        (area code 021) 
        <strong>extension 612</strong>.
        <br>
        <u>
            We kindly ask that you direct any issues related to the Navid system at your university to our support team.
        </u>
    </p>
    <p style="text-align:center;">🌹🌹 Admin of the Navid system at Intelligent Medical Sciences University 🌹🌹<br><br><br><br><br>&nbsp;</p>
    <p></p>
</div>
';
$string['region-course-vums'] = 'Gamification Blocks';
