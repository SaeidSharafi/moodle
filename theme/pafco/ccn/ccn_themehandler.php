...
include($CFG->dirroot . '/theme/pafco/ccn/ccn_loginform.php');
include($CFG->dirroot . '/theme/pafco/ccn/ccn_globalsearch.php');
include($CFG->dirroot . '/theme/pafco/ccn/ccn_globalsearch_navbar.php');
include($CFG->dirroot . '/theme/pafco/ccn/ccn_librarylist.php');
include($CFG->dirroot . '/theme/pafco/ccn/course_handler/ccn_activity_nav.php');
require_once($CFG->dirroot. '/theme/pafco/ccn/user_handler/ccn_user_handler.php');
require_once($CFG->dirroot. '/theme/pafco/ccn/page_handler/ccn_page_handler.php');
...
/* @ccnComm: Visualize */
// if (isset($_GET['pafco_customizer'])) {
//   require_once($CFG->dirroot. '/theme/pafco/ccn/visualize/ccn_lcvb_construct.php');
// }

/* @ccnBreak */
if (is_siteadmin()) {$user_status = 'role-supreme';} else {$user_status = 'role-standard';}
if(method_exists('theme_pafco\output\core_renderer', 'get_theme_image_headerlogo1') && method_exists('theme_pafco\output\core_renderer_maintenance', 'get_theme_image_headerlogo1') && !empty($OUTPUT->get_theme_image_headerlogo1())){
  $headerlogo1 = $OUTPUT->get_theme_image_headerlogo1(null, 100);
} else {
  $headerlogo1 = $CFG->wwwroot . '/theme/pafco/images/header-logo.png';
}
if(method_exists('theme_pafco\output\core_renderer', 'get_theme_image_headerlogo2') && method_exists('theme_pafco\output\core_renderer_maintenance', 'get_theme_image_headerlogo2') && !empty($OUTPUT->get_theme_image_headerlogo2())){
  $headerlogo2 = $OUTPUT->get_theme_image_headerlogo2(null, 100);
} else {
  $headerlogo2 = $CFG->wwwroot . '/theme/pafco/images/header-logo2.png';
}
if(method_exists('theme_pafco\output\core_renderer', 'get_theme_image_headerlogo3') && method_exists('theme_pafco\output\core_renderer_maintenance', 'get_theme_image_headerlogo3') && !empty($OUTPUT->get_theme_image_headerlogo3())){
  $headerlogo3 = $OUTPUT->get_theme_image_headerlogo3(null, 100);
} else {
  $headerlogo3 = $CFG->wwwroot . '/theme/pafco/images/header-logo4.png';
}
if(method_exists('theme_pafco\output\core_renderer', 'get_theme_image_headerlogo4') && method_exists('theme_pafco\output\core_renderer_maintenance', 'get_theme_image_headerlogo4') && !empty($OUTPUT->get_theme_image_headerlogo4())){
  $headerlogo4 = $OUTPUT->get_theme_image_headerlogo4(null, 100);
} else {
  $headerlogo4 = $CFG->wwwroot . '/theme/pafco/images/header-logo.png';
}
if(method_exists('theme_pafco\output\core_renderer', 'get_theme_image_headerlogo_mobile') && method_exists('theme_pafco\output\core_renderer_maintenance', 'get_theme_image_headerlogo_mobile') && !empty($OUTPUT->get_theme_image_headerlogo_mobile())){
  $headerlogo_mobile = $OUTPUT->get_theme_image_headerlogo_mobile(null, 100);
} else {
  $headerlogo_mobile = $CFG->wwwroot . '/theme/pafco/images/header-logo.png';
}
if(method_exists('theme_pafco\output\core_renderer', 'get_theme_image_footerlogo1') && method_exists('theme_pafco\output\core_renderer_maintenance', 'get_theme_image_footerlogo1') && !empty($OUTPUT->get_theme_image_footerlogo1())){
  $footerlogo1 = $OUTPUT->get_theme_image_footerlogo1(null, 100);
} else {
  $footerlogo1 = $CFG->wwwroot . '/theme/pafco/images/header-logo.png';
}
if(method_exists('theme_pafco\output\core_renderer', 'get_theme_image_heading_bg') && method_exists('theme_pafco\output\core_renderer_maintenance', 'get_theme_image_heading_bg') && !empty($OUTPUT->get_theme_image_heading_bg())){
  $heading_bg = $OUTPUT->get_theme_image_heading_bg(null, 100);
} else {
  $heading_bg = $CFG->wwwroot . '/theme/pafco/images/background/inner-pagebg.jpg';
}
if(method_exists('theme_pafco\output\core_renderer', 'get_theme_image_favicon') && method_exists('theme_pafco\output\core_renderer_maintenance', 'get_theme_image_favicon') && !empty($OUTPUT->get_theme_image_favicon())){
  $favicon = $OUTPUT->get_theme_image_favicon(null, 100);
} else {
  $favicon = $CFG->wwwroot . '/theme/pafco/pix/favicon.ico';
}
$langMenu = $OUTPUT->ccn_render_lang_menu();
$headertype = get_config('theme_pafco', 'headertype');
$headertype_settings = get_config('theme_pafco', 'headertype_settings');
$header_search = get_config('theme_pafco', 'header_search');
$header_login = get_config('theme_pafco', 'header_login');
$footertype = get_config('theme_pafco', 'footertype');
$breadcrumb_style = get_config('theme_pafco', 'breadcrumb_style');
$preloader_duration = get_config('theme_pafco', 'preloader_duration');
$blogstyle = get_config('theme_pafco', 'blogstyle');
$courseliststyle = get_config('theme_pafco', 'courseliststyle');
$showCourseStartDate = get_config('theme_pafco', 'course_start_date');
$showCourseCategory = get_config('theme_pafco', 'course_category');
$back_to_top = get_config('theme_pafco', 'back_to_top');
$dashboard_scroll_header = get_config('theme_pafco', 'dashboard_sticky_header');
$dashboard_scroll_drawer = get_config('theme_pafco', 'dashboard_sticky_drawer');
$dashboard_left_drawer = get_config('theme_pafco', 'dashboard_left_drawer');
$ccnSettingLogoUrl = get_config('theme_pafco', 'logo_url');
$logo_image_width = preg_replace("/[^0-9]/", "", get_config('theme_pafco', 'logo_image_width'));
$logo_image_height = preg_replace("/[^0-9]/", "", get_config('theme_pafco', 'logo_image_height'));
$logo_image_width_footer = preg_replace("/[^0-9]/", "", get_config('theme_pafco', 'logo_image_width_footer'));
$logo_image_height_footer = preg_replace("/[^0-9]/", "", get_config('theme_pafco', 'logo_image_height_footer'));
$logo_styles = '';
if ($logo_image_width) {
...
$breadcrumb_clip_setting = get_config('theme_pafco', 'breadcrumb_clip');
$breadcrumb_caps_setting = get_config('theme_pafco', 'breadcrumb_caps');
$breadcrumb_title_setting = get_config('theme_pafco', 'breadcrumb_title');
$breadcrumb_trail_setting = get_config('theme_pafco', 'breadcrumb_trail');
$breadcrumb_classes = '';
...
$dash_breadcrumb_clip_setting = get_config('theme_pafco', 'breadcrumb_clip_dash');
...
$social_target = get_config('theme_pafco', 'social_target');
if($social_target == 1) {
...
if(get_config('theme_pafco', 'page_settings_controls') == 1) {  //Hide Page Settings Controls if not an administrator
...
if(get_config('theme_pafco', 'headertype_settings') == 1) {
...
if(get_config('theme_pafco', 'course_single_style') == 1) { // v2
  $course_single_style_class .= ' ccn_course_single_v2 ';
} elseif(get_config('theme_pafco', 'course_single_style') == 2) { //v3
...
if(get_config('theme_pafco', 'notification_icon_visibility') == '1'){
  $ccnHook_userNotifIcon = 'ccnHook_uni';
}
if(get_config('theme_pafco', 'messages_icon_visibility') == '1'){
  $ccnHook_userMesseIcon = 'ccnHook_umi';
}
if(get_config('theme_pafco', 'header_main_menu') == '1'){
...
$pafco_facebook_url = get_config('theme_pafco', 'pafco_facebook_url');
$pafco_copyright = get_config('theme_pafco', 'pafco_copyright');
...
$incourse_layout_setting = get_config('theme_pafco', 'incourse_layout');
$course_mainpage_layout_setting = get_config('theme_pafco', 'coursemainpage_layout');
...
if($incourse_layout_setting != 0 && $context->id != $context_site->id && !$courseMainPage && !$courseEnrolPage) {
  if($incourse_layout_setting == 1) { //Pafco Dash
    $incourse_layout_dashboard = 1;
    $incourse_layout_focus = 0;
  } elseif($incourse_layout_setting == 2) { //Pafco Focus
    $incourse_layout_dashboard = 0;
    $incourse_layout_focus = 1;
  }
}
...
//} elseif($course_mainpage_layout_setting == 1 && $context->id != $context_site->id && $is_enrolled){ //Pafco Dashboard for enrolled users only
//  // $course_mainpage_layout_dashboard = 1;
//  $course_mainpage_layout_dashboard = '1';
//} elseif($course_mainpage_layout_setting == 2 && $context->id != $context_site->id){ //Pafco Dashboard for all users
//  // $course_mainpage_layout_dashboard = 1;
//  $course_mainpage_layout_dashboard = '1';
//} elseif($course_mainpage_layout_setting == 3 && $context->id != $context_site->id && $is_enrolled){ //Pafco Focus for enrolled users only
//  // $course_mainpage_layout_dashboard = 1;
//  $course_mainpage_layout_dashboard = '2';
//} elseif($course_mainpage_layout_setting == 4 && $context->id != $context_site->id){ //Pafco Focus for all users
//  // $course_mainpage_layout_dashboard = 1;
//  $course_mainpage_layout_dashboard = '2';
//} else {
//  $course_mainpage_layout_dashboard = '0';
...
$ccnDashLayoutSetting = get_config('theme_pafco', 'dashboard_layout');
$ccnDashLayout = 0;
if($ccnDashLayoutSetting == '1'){
  $ccnDashLayout = 1;
}

$singlecourse_blocks_setting = get_config('theme_pafco', 'singlecourse_blocks');
...
$user_profile_layout_setting = get_config('theme_pafco', 'user_profile_layout');
if($user_profile_layout_setting == 1){
  $user_profile_layout_dashboard = 1;
} else {
  $user_profile_layout_dashboard = 0;
}
$course_content_enroled_only = get_config('theme_pafco', 'course_content_enroled_only');
...
if (get_config('theme_pafco', 'library_list') == 0){
  $display_library_list = false;
} else {
  $display_library_list = true;
}
if (get_config('theme_pafco', 'logotype') == 1){
  $logotype = false;
} else {
  $logotype = true;
}
if (get_config('theme_pafco', 'logo_image') == 1){
  $logo_image = false;
} else {
  $logo_image = true;
}
...
if (get_config('theme_pafco', 'logotype_footer') == 1){
  $logotype_footer = false;
} else {
  $logotype_footer = true;
}
if (get_config('theme_pafco', 'logo_image_footer') == 1){
...
if(get_config('theme_pafco', 'custom_css')){
  $custom_css = '<style>'.get_config('theme_pafco', 'custom_css').'</style>';
} else {
  $custom_css = '';
}
if(get_config('theme_pafco', 'custom_css_dashboard')){
  $custom_css_dashboard = '<style>'.get_config('theme_pafco', 'custom_css_dashboard').'</style>';
} else {
  $custom_css_dashboard = '';
}
if(get_config('theme_pafco', 'custom_js')){
  $custom_js = '<script>'.get_config('theme_pafco', 'custom_js').'</script>';
} else {
  $custom_js = '';
}
if(get_config('theme_pafco', 'custom_js_dashboard')){
  $custom_js_dashboard = '<script>'.get_config('theme_pafco', 'custom_js_dashboard').'</script>';
} else {
  $custom_js_dashboard = '';
}

$ccnProfileIconUsername = $USER->username;
if(get_config('theme_pafco', 'profile_icon_username') == '1'){
  $ccnProfileIconUsername = $USER->firstname . ' '. $USER->lastname;
}

// Dash tab 1
if(get_config('theme_pafco', 'dashboard_tablet_1_title')){
  $dash_tablet_1_title = get_config('theme_pafco', 'dashboard_tablet_1_title');
} else {
  $dash_tablet_1_title = get_string('messages_title', 'theme_pafco');
}
if(get_config('theme_pafco', 'dashboard_tablet_1_subtitle')){
  $dash_tablet_1_subtitle = get_config('theme_pafco', 'dashboard_tablet_1_subtitle');
} else {
  $dash_tablet_1_subtitle = get_string('messages_desc', 'theme_pafco');
}
if(get_config('theme_pafco', 'dashboard_tablet_1_url')){
  $dash_tablet_1_link = get_config('theme_pafco', 'dashboard_tablet_1_url');
} else {
  $dash_tablet_1_link = $messages_link;
}
$dash_tablet_1_icon = get_config('theme_pafco', 'dashboard_tablet_1_ccn_icon_class');

// Dash tab 2
if(get_config('theme_pafco', 'dashboard_tablet_2_title')){
  $dash_tablet_2_title = get_config('theme_pafco', 'dashboard_tablet_2_title');
} else {
  $dash_tablet_2_title = get_string('profile_title', 'theme_pafco');
}
if(get_config('theme_pafco', 'dashboard_tablet_2_subtitle')){
  $dash_tablet_2_subtitle = get_config('theme_pafco', 'dashboard_tablet_2_subtitle');
} else {
  $dash_tablet_2_subtitle = get_string('profile_desc', 'theme_pafco');
}
if(get_config('theme_pafco', 'dashboard_tablet_2_url')){
  $dash_tablet_2_link = get_config('theme_pafco', 'dashboard_tablet_2_url');
} else {
  $dash_tablet_2_link = $profile_link;
}
$dash_tablet_2_icon = get_config('theme_pafco', 'dashboard_tablet_2_ccn_icon_class');

// Dash tab 3
if(get_config('theme_pafco', 'dashboard_tablet_3_title')){
  $dash_tablet_3_title = get_config('theme_pafco', 'dashboard_tablet_3_title');
} else {
  $dash_tablet_3_title = get_string('preferences_title', 'theme_pafco');
}
if(get_config('theme_pafco', 'dashboard_tablet_3_subtitle')){
  $dash_tablet_3_subtitle = get_config('theme_pafco', 'dashboard_tablet_3_subtitle');
} else {
  $dash_tablet_3_subtitle = get_string('preferences_desc', 'theme_pafco');
}
if(get_config('theme_pafco', 'dashboard_tablet_3_url')){
  $dash_tablet_3_link = get_config('theme_pafco', 'dashboard_tablet_3_url');
} else {
  $dash_tablet_3_link = $preferences_link;
}
$dash_tablet_3_icon = get_config('theme_pafco', 'dashboard_tablet_3_ccn_icon_class');

// Dash tab 4
if(get_config('theme_pafco', 'dashboard_tablet_4_title')){
  $dash_tablet_4_title = get_config('theme_pafco', 'dashboard_tablet_4_title');
} else {
  $dash_tablet_4_title = get_string('grades_title', 'theme_pafco');
}
if(get_config('theme_pafco', 'dashboard_tablet_4_subtitle')){
  $dash_tablet_4_subtitle = get_config('theme_pafco', 'dashboard_tablet_4_subtitle');
} else {
  $dash_tablet_4_subtitle = get_string('grades_desc', 'theme_pafco');
}
if(get_config('theme_pafco', 'dashboard_tablet_4_url')){
  $dash_tablet_4_link = get_config('theme_pafco', 'dashboard_tablet_4_url');
} else {
  $dash_tablet_4_link = $grades_link;
}
$dash_tablet_4_icon = get_config('theme_pafco', 'dashboard_tablet_4_ccn_icon_class');
...
$dash_tablet_3 = false;
$dash_tablet_4 = false;
if(get_config('theme_pafco', 'dashboard_tablet_1_visibility') == 0){
  $dash_tablet_count++;
  $dash_tablet_1 = true;
}
if(get_config('theme_pafco', 'dashboard_tablet_2_visibility') == 0){
  $dash_tablet_count++;
  $dash_tablet_2 = true;
}
if(get_config('theme_pafco', 'dashboard_tablet_3_visibility') == 0){
  $dash_tablet_count++;
  $dash_tablet_3 = true;
}
if(get_config('theme_pafco', 'dashboard_tablet_4_visibility') == 0){
  $dash_tablet_count++;
  $dash_tablet_4 = true;
}
...
if(get_config('theme_pafco', 'footer_col_1_title') || get_config('theme_pafco', 'footer_col_1_body')){
  $footer_column_count++;
  $footer_column_1 = true;
}
if(get_config('theme_pafco', 'footer_col_2_title') || get_config('theme_pafco', 'footer_col_2_body')){
  $footer_column_count++;
  $footer_column_2 = true;
}
if(get_config('theme_pafco', 'footer_col_3_title') || get_config('theme_pafco', 'footer_col_3_body')){
  $footer_column_count++;
  $footer_column_3 = true;
}
if(get_config('theme_pafco', 'footer_col_4_title') || get_config('theme_pafco', 'footer_col_4_body')){
  $footer_column_count++;
  $footer_column_4 = true;
}
if(get_config('theme_pafco', 'footer_col_5_title') || get_config('theme_pafco', 'footer_col_5_body')){
  $footer_column_count++;
