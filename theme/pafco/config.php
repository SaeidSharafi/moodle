...
if (isset($_GET['bui_editid']) && isset($_GET['pafco_live_customizer'])) {
  $ccnAdminLayout = 'ccn_visualize_block.php';
}

$ccnInCourseRegions = array('fullwidth-top', 'fullwidth-bottom', 'above-content', 'below-content', 'left', 'side-pre', 'course-vums');
if(!empty($THEME->settings->quiz_layout) && $THEME->settings->quiz_layout == '1'){
  $ccnInCourseRegions = array('side-pre', 'fullwidth-bottom', 'above-content', 'below-content', 'left', 'fullwidth-top', 'course-vums');
}
...
$THEME->layouts = [
    ...
    'course' => array(
        'file' => 'ccn_course.php',
        'regions' => array( 'course-vums','fullwidth-top', 'fullwidth-bottom', 'above-content', 'below-content', 'left', 'side-pre'),
        'defaultregion' => 'course-vums',
...
$ccnSheetsTheme[] = 'pafco';
$ccnSheetsTheme[] = 'dashbord_navitaion';
$ccnSheetsTheme[] = 'pafco-mdl';
$ccnSheetsTheme[] = 'pafco-dashboard';
$ccnSheetsTheme[] = 'responsive';

$ccnSheetsAppend = [];
$ccnSheetsReset[] = 'pafco-mdl-reset';
if($ccnMdlVersion == '37') {
  $ccnSheetsReset[] = 'pafco.mdl.reset.37';
  $ccnSheetsAppend[] = 'pafco.mdl.37';
}
if($ccnMdlVersion == '38') {
  $ccnSheetsReset[] = 'pafco.mdl.reset.38';
  $ccnSheetsAppend[] = 'pafco.mdl.38';
}
if($ccnMdlVersion == '39') {
  $ccnSheetsReset[] = 'pafco.mdl.reset.39';
  $ccnSheetsAppend[] = 'pafco.mdl.39';
}
if($ccnMdlVersion == '310') {
  $ccnSheetsReset[] = 'pafco.mdl.reset.310';
  $ccnSheetsAppend[] = 'pafco.mdl.310';
}
if($ccnMdlVersion == '311') {
  $ccnSheetsReset[] = 'pafco.mdl.reset.311';
  $ccnSheetsAppend[] = 'pafco.mdl.311';
}

if((int)$ccnMdlVersion >= 400) {
  $ccnSheetsReset[] = 'pafco.mdl.reset.400';
  $ccnSheetsAppend[] = 'pafco.mdl.400';
  $ccnSheetsAppend[] = 'bootstrap-pafco';
}
if((int)$ccnMdlVersion >= 401) {
  $ccnSheetsReset[] = 'pafco.mdl.reset.401';
}

if(!empty($THEME->settings->headertype) && $THEME->settings->headertype == 2 ){
  $ccnSheetsAppend[] = 'pafco.header.2';
  if((int)$ccnMdlVersion >= 400) $ccnSheetsAppend[] = 'pafco.header.2.400';
} elseif(!empty($THEME->settings->headertype) && $THEME->settings->headertype == 3 ){
  $ccnSheetsAppend[] = 'pafco.header.3';
  if((int)$ccnMdlVersion >= 400) $ccnSheetsAppend[] = 'pafco.header.3.400';
} elseif(!empty($THEME->settings->headertype) && $THEME->settings->headertype == 4 ){
  $ccnSheetsAppend[] = 'pafco.header.4';
  if((int)$ccnMdlVersion >= 400) $ccnSheetsAppend[] = 'pafco.header.4.400';
} elseif(!empty($THEME->settings->headertype) && $THEME->settings->headertype == 5 ){
  $ccnSheetsAppend[] = 'pafco.header.5';
  if((int)$ccnMdlVersion >= 400) $ccnSheetsAppend[] = 'pafco.header.5.400';
} elseif(!empty($THEME->settings->headertype) && $THEME->settings->headertype == 6 ){
  $ccnSheetsAppend[] = 'pafco.header.6';
  if((int)$ccnMdlVersion >= 400) $ccnSheetsAppend[] = 'pafco.header.6.400';
} elseif(!empty($THEME->settings->headertype) && $THEME->settings->headertype == 7 ){
  $ccnSheetsAppend[] = 'pafco.header.7';
  if((int)$ccnMdlVersion >= 400) $ccnSheetsAppend[] = 'pafco.header.7.400';
} elseif(!empty($THEME->settings->headertype) && $THEME->settings->headertype == 8 ){
  $ccnSheetsAppend[] = 'pafco.header.8';
  if((int)$ccnMdlVersion >= 400) $ccnSheetsAppend[] = 'pafco.header.8.400';
} elseif(!empty($THEME->settings->headertype) && $THEME->settings->headertype == 9 ){
  $ccnSheetsAppend[] = 'pafco.header.9';
  if((int)$ccnMdlVersion >= 400) $ccnSheetsAppend[] = 'pafco.header.9.400';
} elseif(!empty($THEME->settings->headertype) && $THEME->settings->headertype == 10 ){
  $ccnSheetsAppend[] = 'pafco.header.10';
  if((int)$ccnMdlVersion >= 400) $ccnSheetsAppend[] = 'pafco.header.10.400';
} elseif(!empty($THEME->settings->headertype) && $THEME->settings->headertype == 11 ){
  $ccnSheetsAppend[] = 'pafco.header.11';
  if((int)$ccnMdlVersion >= 400) $ccnSheetsAppend[] = 'pafco.header.11.400';
} elseif(!empty($THEME->settings->headertype) && $THEME->settings->headertype == 12 ){
  $ccnSheetsAppend[] = 'pafco.header.12';
  if((int)$ccnMdlVersion >= 400) $ccnSheetsAppend[] = 'pafco.header.12.400';
} elseif(!empty($THEME->settings->headertype) && $THEME->settings->headertype == 13 ){
  $ccnSheetsAppend[] = 'pafco.header.13';
  if((int)$ccnMdlVersion >= 400) $ccnSheetsAppend[] = 'pafco.header.13.400';
} elseif(!empty($THEME->settings->headertype) && $THEME->settings->headertype == 14 ){
  $ccnSheetsAppend[] = 'pafco.header.14';
  if((int)$ccnMdlVersion >= 400) $ccnSheetsAppend[] = 'pafco.header.14.400';
} else {
  $ccnSheetsAppend[] = 'pafco.header.1';
  if((int)$ccnMdlVersion >= 400) $ccnSheetsAppend[] = 'pafco.header.1.400';
}

if(!empty($THEME->settings->footertype) && $THEME->settings->footertype == 9 ){
  $ccnSheetsAppend[] = 'pafco.footer.9';
}
...
//   return theme_pafco_get_main_scss_content($theme);
// };
$THEME->javascripts = array(
  'pafco.init.preprocess',
  'pafco.init.lcvb.frontend.preprocess.min',
  'jquery-migrate-3.0.0.min',
  'pafco.preprocess',
  'pafco.dashboard.preprocess',
  'jquery.mmenu.all',
  'ace-responsive-menu',
  'bootstrap-select.min',
  'pafco.script.isotope',
  'magnific-popup',
  'snackbar.min',
  //'simplebar',
  'pafco.script.parallax-scene',
  'parallax',
  'scrollto',
...
$THEME->iconsystem = '\\theme_pafco\\output\\icon_system_fontawesome';

$THEME->csspostprocess = 'theme_pafco_process_css';
