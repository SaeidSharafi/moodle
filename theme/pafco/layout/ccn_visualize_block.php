...
$PAGE->requires->css('/theme/pafco/style/ccn-visualize.css');
$PAGE->requires->js('/theme/pafco/javascript/pafco.lcvb.preprocess.min.js', true);


if (isset($_GET['bui_editid'])) {
  $ccnvbid = $_GET['bui_editid'];
  $ccnLcVbUpdCall = $CFG->wwwroot . '/theme/pafco/ccn/visualize/ccn_lcvb_updresp.php?ccn_bid=' . $ccnvbid;
...
echo $OUTPUT->render_from_template('theme_pafco/ccn_lc_vb', $templatecontext);
