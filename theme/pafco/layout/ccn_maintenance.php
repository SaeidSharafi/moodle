...
if((int)$ccnMdlVersion >= 400) {
  ...
  echo $OUTPUT->render_from_template('theme_pafco/ccn_mdl_400/ccn_maintenance', $templatecontext);
} else {
  ...
  echo $OUTPUT->render_from_template('theme_pafco/ccn_clean', $templatecontext);
}
