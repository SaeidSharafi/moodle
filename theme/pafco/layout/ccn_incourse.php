...
if ($incourse_layout_dashboard == 1) {
  ...
  include($CFG->dirroot . '/theme/pafco/ccn/ccn_themehandler_context.php');
  if((int)$ccnMdlVersion >= 400) {
    echo $OUTPUT->render_from_template('theme_pafco/ccn_mdl_400/ccn_focus', $templatecontext);
  } else {
    echo $OUTPUT->render_from_template('theme_pafco/ccn_focus', $templatecontext);
  }
} else {
