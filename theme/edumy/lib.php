...
function theme_edumy_process_css($css, $theme) {
    ...
    if($theme->settings->primary_font == 1) {
        $font_src = '@font-face {
                     ...
                     src: url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb_Bold.eot");
                     src: url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb_Bold.eot#iefix") format("embedded-opentype"),
                          url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb_Bold.woff2") format("woff2"),
                          url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb_Bold.woff") format("woff"),
                          url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb_Bold.ttf") format("truetype"),
                          url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb_Bold.svg") format("svg");
                     font-weight: normal;
                     font-style: normal;
                   }';
        ...
        $font_src = '@font-face {
                     ...
                     src: url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb_FaNum.eot");
                     src: url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb_FaNum.eot#iefix") format("embedded-opentype"),
                          url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb_FaNum.woff2") format("woff2"),
                          url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb_FaNum.woff") format("woff"),
                          url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb_FaNum.ttf") format("truetype"),
                          url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb_FaNum.svg") format("svg");
                     font-weight: normal;
                     font-style: normal;
                   }';
      ...
      $font_src = 'https://fonts.googleapis.com/css?family=Oxygen:400,500,600,700';
        ...
        $font_src = '@font-face {
                     ...
                     src: url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb.eot");
                     src: url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb.eot#iefix") format("embedded-opentype"),
                          url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb.woff2") format("woff2"),
                          url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb.woff") format("woff"),
                          url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb.ttf") format("truetype"),
                          url("'.$CFG->wwwroot.'/theme/edumy/fonts/IRANSansWeb.svg") format("svg");
                     font-weight: normal;
                     font-style: normal;
                   }';
        $font_name = 'IransSans';
