...
require_once(dirname(__FILE__, 3).'/lib/accesslib.php');
...
$ac->login = $configs->admin_login;
$ac->host = $configs->host;
$ac->port = $configs->port;
$ac->pass = $configs->admin_password;
$ac->httpauth = $configs->admin_httpauth;
$ac->emaillogin = $configs->email_login;
$ac->https = $configs->https;
...
adobe_connection_test($ac->emaillogin, $ac->host, $ac->port, $ac->login,
    $ac->pass, $ac->httpauth,
    $ac->https);
