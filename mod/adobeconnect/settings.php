...
if ($hassiteconfig) {
    ...
    if ($ADMIN->fulltree) {
        ...
        //$ADMIN->add('modsettings', new admin_category('mod_adobeconnect', 'Adobe Connect'));
        //
        //$settingspage = new admin_settingpage('mod_adobeconnect_general',
        //        get_string('adobeconnect_generalsettings', 'adobeconnect'));
        ...
        $settings->add(new admin_setting_heading('adobeconnect_offline_server', '', $title));
        ...
        $settings->add(new admin_setting_heading('adobeconnect_intro', '',
                get_string('settingblurb', 'adobeconnect', $param)));
