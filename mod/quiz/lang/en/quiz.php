...
$string['forceanswers_desc'] = 'If you enable this option, then users must answer all questions to proceed to next page or finish their attempt.';
...
$string['forceanswers'] = 'force answering';
...
$string['mustanswerallquestions'] = 'you must answer all the question to proceed';