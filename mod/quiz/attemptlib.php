...
class quiz_attempt
{
    ...
    {
        return new moodle_url('/mod/quiz/summary.php',
     ...
     */
    protected function render_question_helper(
        $slot,
        $reviewing,
        $thispageurl,
     ...
     * @return string HTML for the question in its current state.
     */
    public function render_question_at_step(
        $slot,
        $seq,
        $reviewing,
        mod_quiz_renderer $renderer,
     ...
     */
    public function get_navigation_panel(
        mod_quiz_renderer $output,
        $panelclass,
        $page,
        $showall = false
    ) {
