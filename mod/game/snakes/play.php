...
?>
    ...
    <table style="direction: ltr;text-align: left;max-width: 800px;margin: 0 auto;">
    <tr>
        <td>
...
top:<?php p( -2 * round($board->height / 3));?>px; ">
    <img src="snakes/2/dice<?php p($snakes->dice);?>.png" alt="<?php print_string('snakes_dice', 'game', $snakes->dice) ?>" />
    </div>
    <?php
}
