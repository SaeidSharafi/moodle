...
$string['otpsenterror_number'] = 'An error occurred while sending one-time password. Code: ';
...
$string['enablemagfa'] = 'Enable Magfa SMS Service';
$string['enablemagfa_help'] = 'Enable Magfa SMS Service and stop other services';
$string['magfa_username'] = 'Magfa username';
$string['magfa_username_help'] = 'Magfa username';
$string['magfa_password'] = 'Magfa Password';
$string['magfa_password_help'] = 'Magfa Password';
$string['magfa_number'] = 'Magfa Number';
$string['magfa_number_help'] = 'Magfa Registered Number';
$string['magfa_domain'] = 'Domain';
$string['magfa_domain_help'] = 'It is the word "magfa" typically.';
$string['magfa_templatetext'] = 'Template of message';
$string['magfa_templatetext_help'] = 'This message is sent to the user. You can use variable "{code}".';
$string['magfa_templatetext_default'] = 'Your activation code: {code}';
...
$string['invalidphonenumber'] = 'Insert valid phone number.';
$string['phonenumberempty'] = 'Phone number can\'t be empty';
