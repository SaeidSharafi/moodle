...
$string['enablerangineh'] = 'Enable Rangineh SMS Service';
$string['enablerangineh_help'] = 'Enable Rangineh SMS Service and stop other services';
$string['rangineh_username'] = 'Rangineh username';
$string['rangineh_username_help'] = 'Rangineh username';
$string['rangineh_password'] = 'Rangineh Password';
$string['rangineh_password_help'] = 'Rangineh Password';
$string['rangineh_number'] = 'Rangineh Number';
$string['rangineh_number_help'] = 'Rangineh Registered Number';
