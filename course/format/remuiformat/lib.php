...
class format_remuiformat extends core_courseformat\base
{
     ...
     * If the section number is not 0, the base implementation of format_remuiformat::get_default_section_name which
    ...
    public function get_default_section_name($section)
    {
        ...
        if ($section->section == 1) {
            // Return the general section.
            return get_string('section1name', 'format_remuiformat');
        }
        if ($section->section == 2) {
            // Return the general section.
            return get_string('section2name', 'format_remuiformat');
        }
        if ($section->section == 3) {
            // Return the general section.
            return get_string('section3name', 'format_remuiformat');
        }
        if ($section->section == 4) {
            // Return the general section.
            return get_string('section4name', 'format_remuiformat');
        }
 ...
 */
function format_remuiformat_pluginfile(
    $course,
    $cm,
    $context,
    $filearea,
...
function get_extra_header_context(&$export, $course, $percentage, $imgurl)
{
    ...
    $export->generalsection['studentscount'] = get_enrolled_students_count($course->id);
    ...
    if ($CFG->theme == 'remui') {
        $export->generalsection['courseheaderdesign'] = get_config('theme_remui', 'courseheaderdesign') == 0 ? false
            : true;
