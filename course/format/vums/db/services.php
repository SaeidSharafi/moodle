...
$functions = [
    'format_vums_move_activities' => [
        'classname' => 'format_vums\external\api',
    ...
    'format_vums_show_activity_in_row' => [
        'classname' => 'format_vums\external\api',
    ...
    'format_vums_move_activity_to_section' => [
        'classname' => 'format_vums\external\api',
    ...
    'format_vums_course_progress_data' => [
        'classname' => 'format_vums\external\api',
    ...
    'format_vums_get_filtered_modchooser' => [
        'classname' => 'format_vums\external\api',
        'methodname' => 'get_filtered_modchooser',
        'classpath' => '',
        'description' => 'Get filtered modchooser activities based on section ID',
        'type' => 'read',
        'ajax' => true,
