...
The primary source is on https://github.com/WisdmLabs/moodle-format_vums
...
1. Download vums.zip file from the purchase receipt.
2. Open your Moodle website and go to Site administration > Plugins > Install plugins.
3. Choose the vums.zip’ file. Then click on Install plugin from zip file.
...
3. Copy 'vums' to '/course/format/' if you have not already done so.
4. Go back in as an administrator and follow standard the 'plugin' update notification.  If needed, go to
   'Site administration' -> 'Notifications' if this does not happen.
5. Put Moodle out of Maintenance Mode.
6. You may need to check that the permissions within the 'vums' folder are 755 for folders and 644 for files.
...
4. In '/course/format/' remove the folder 'vums'.
5. Put Moodle out of Maintenance Mode.
...
Languages
---------
The vums/lang folder contains the language files for the format.
...
Styles
------
The file vums/styles.css contains the CSS styles for the format.
...
[![alt text](https://git.wisdmlabs.net/edwiser/vums/raw/dev/images/readme-img.png)](https://edwiser.org)
