...
class renderer extends section_renderer
{
    ...
    public function __construct(\moodle_page $page, $target) {
        ...
        // Since format_vums_renderer::section_edit_controls()
    ...
    protected function page_title() {
        return get_string('sectionname', 'format_vums');
    }
    ...
    public function section_activity_summary($section, $course, $mods) {
        ...
        if ($total > 0) {
            ...
            $o .= \html_writer::tag(
                'p', get_string('progress', 'format_vums'), array('class' => 'progress-title m-0 text-muted')
            );
    ...
    public function render_cm($cm) {
        // Use the custom template in your course format.
        $data = $cm->export_for_template($this);
        return $this->render_from_template('format_vums/local/content/cm/activity', $data);
    }
     ...
     * @param \format_vums\output\format_vums_card_all_sections_summary $section Object of the Section renderable.
     */
    public function render_card_all_sections_summary(
        \format_vums\output\format_vums_card_all_sections_summary $section) {
        ...
        if (isset($templatecontext->error)) {
            ...
            echo $this->render_from_template('format_vums/card_all_sections_summary', $templatecontext);
        }
    }

    /**
     * Renders the card one section page.
     * @param \format_vums\output\format_vums_card_one_section $activity Object of Activity renderable
     */
    public function render_card_one_section(
        \format_vums\output\format_vums_card_one_section $activity) {
        $templatecontext = $activity->export_for_template($this);
        echo $this->render_from_template('format_vums/card_one_section', $templatecontext);
    }

    /**
     * Renders the list all sections page with all activities.
     * @param \format_vums\output\format_vums_list_all_sections $section Object of the Section renderable.
     */
    public function render_list_all_sections(
        \format_vums\output\format_vums_list_all_sections $section) {
        $templatecontext = $section->export_for_template($this);
        if (isset($templatecontext->error)) {
            throw new \moodle_exception($templatecontext->error);
        } else {
            echo $this->render_from_template('format_vums/list_all_sections', $templatecontext);
        }
    }
     ...
     * @param \format_vums\output\format_vums_list_all_sections_summary $section Object of the Section renderable.
     */
    public function render_list_all_sections_summary(
        \format_vums\output\format_vums_list_all_sections_summary $section) {
        $templatecontext = $section->export_for_template($this);
        if (isset($templatecontext->error)) {
            throw new \moodle_exception($templatecontext->error);
        } else {
            echo $this->render_from_template('format_vums/list_all_sections_summary', $templatecontext);
        }
    }

    /**
     * Renders the list one section page.
     * @param \format_vums\output\format_vums_list_one_section $activity Object of Activity renderable
     */
    public function render_list_one_section(
        \format_vums\output\format_vums_list_one_section $activity) {
        $templatecontext = $activity->export_for_template($this);
        echo $this->render_from_template('format_vums/list_one_section', $templatecontext);
    }
    ...
    public function render_content() {
        ...
        echo $this->render_from_template('format_vums/local/content/content', $data);
    }
}
