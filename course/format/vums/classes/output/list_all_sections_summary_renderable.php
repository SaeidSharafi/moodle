 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_vums_list_all_sections_summary implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        if ($rformat == VUMS_LIST_FORMAT) {
            $PAGE->requires->js_call_amd('format_vums/format_list', 'init');
     ...
     * @param  format_vums $renderer format renderer
    ...
    private function get_list_format_context(&$export, $renderer, $editing, $rformat) {
        ...
        $defaultview = $this->settings['vumsdefaultsectionview'];
