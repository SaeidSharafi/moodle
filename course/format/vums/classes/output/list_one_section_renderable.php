 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_vums_list_one_section implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $export->vumscourseformatlist = true;
        ...
        foreach ($sections as $index => $sectioninfo) {
            ...
            $export->sections[] = $section;
                 ...
                 $coursecontext,
                 $this->settings['vumscourseimage_filemanager']
                 );
        if (empty($imgurl)) {
        ...
        $export->headerdata = get_vums_extra_header_context(
            $export,
            $this->course,
