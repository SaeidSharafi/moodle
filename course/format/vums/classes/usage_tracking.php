...
class usage_tracking {
    ...
    private function prepare_usage_analytics() {
        ...
        $analyticsdata = array(
            ...
            'product_settings' => $this->get_plugin_settings('format_vums'),
            'active_theme' => @$CFG->theme,
            // Include only with format type vumscourseformat.
            'total_courses' => $DB->count_records('course', array('format' => 'vums')),
    ...
    /**
     * Get specific settings of the current plugin, eg: vums
