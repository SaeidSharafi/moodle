...
$string['all'] = "همه";
$string['allcomplete'] = 'همه کامل شده';
...
$string['areyousure?'] = 'آیا طمینان دارید؟';
$string['asfraction'] = 'به صورت کسر نمایش بده';
...
$string['aspercentagedial'] = 'به صورت % در یک دایره نمایش بده';
...
$string['colourblue'] = 'آبی';
$string['colourdarkgreen'] = 'سبز تیره';
$string['colourgreen'] = 'سبز';
$string['colourlightblue'] = 'آبی روشن';
$string['colourpurple'] = 'بنفش';
$string['colourred'] = 'قرمز';
$string['contact'] = 'Get in touch';
$string['contactdeveloper'] = 'Contact developer';
$string['close'] = 'بستن';
$string['collapse'] = 'بستن بخش';
$string['collapsesections'] = 'بستن همه';
$string['colours'] = 'رنگ ها';
...
$string['complete-n-auto'] = 'آیتم تکمیل نشده است زمانی که موارد مورد نیاز جهت تکمیل آیتم را انجام این بخش تکمیل خواهد شد. امکان تغیر دستی وجود ندارد';
$string['complete-y-auto'] = 'آیتم تکمیل شده است. شما امکان تغییر دستی وضعیت را ندارید';
...
$string['completionwarning_changeinbulk'] = 'تغییر جمعی';
$string['contents'] = 'محتوا';
$string['converttopage'] = 'تبدیل کردن به صفحه';
...
$string['courseshowtileprogress'] = 'پیشرفت بر روی هر عنوان';
...
$string['currentsection'] = 'این عنوان';
...
$string['defaulttilecolour'] = 'رنگ پیشفرض بخش';
$string['defaulttileicon'] = 'آیکن عنوان';
$string['defaultthiscourse'] = 'پیشفرض برای این درس';
$string['deletesection'] = 'حذف بخش';
$string['deleteimage'] = 'حذف تصویر';
$string['developedby'] = '';
...
$string['displayfilterbar'] = 'نوار فیلتر';
$string['displaytitle_mod_pdf'] = 'PDF';
$string['displaytitle_mod_mp3'] = 'صوت';
$string['displaytitle_mod_mp4'] = 'ویدئو';
$string['displaytitle_mod_doc'] = 'Word document';
$string['displaytitle_mod_jpeg'] = 'تصویر';
$string['displaytitle_mod_html'] = 'صفحه وب';
$string['displaytitle_mod_xls'] = 'صفحه گسترده';
$string['displaytitle_mod_txt'] = 'متن';
$string['displaytitle_mod_ppt'] = 'پاورپوینت';
$string['displaytitle_mod_zip'] = 'فایل فشرده';
...
$string['imagesize'] = 'اندازه تصویر';
$string['tootall'] = 'ارتفاع تصویر بیش از حد می باشد';
$string['height'] = 'ارتفاع';
$string['imagedeletedfrom'] = 'Image deleted from "{$a}"';
$string['items'] = 'آیتم ها';
...
$string['overallprogress'] = 'پیشرفت کلی فعالیت';
$string['overallprogressshort'] = 'میزان پیشرفت کلی';
$string['overall'] = 'همه';
$string['picknewicon'] = 'انتخاب آیکن';
$string['picknewiconphoto'] = 'انتخاب تصویر و یا آیکن جدید';
$string['photoguidance_desc'] = '<p>یک تصویر با فرمت  <strong>landscape</strong> را بارگذاری کنید.  عرض تصویر باید حدود 1.35 برابر ارتفاع آن باشد. برای مثال تصویری با ابعاد 270 در 200 مناسب می باشد.</p>
	<p>تصاویری با فرمت پرتره با اندازه بخش ها برابر نخواهند بود. تصاویر بزرگ در صورت نیاز فشرده و کوچک خواهند شد</p>';
$string['photolibrary'] = 'کتابخانه تصاویر';
$string['pluginname'] = 'قالب کاشی';
...
$string['sectionname'] = 'عنوان';
$string['sectionnumber'] = 'شماره بخش / عنوان';
...
$string['revealcontents'] = 'نمایش محتوای بخش';
$string['showfromothers'] = 'نمایش عنوان';
...
$string['uploadnewphoto'] = 'آپلود تصویر جدید';
...
$string['usesubtilesseczero'] = 'نمایش زیر بخش در بخش بالا';
...
$string['tilesoutofsequencewarning'] = 'بخش های زیر دارای خطا هستند، جهت رفع خطا لطفا بر روی دکمه زیر کلیک کنید و یا بخش های مورد اشاره را حذف نمایید:';
$string['tileoutofsequence'] = 'این بخش عدیی خارج از ردیف بخش ها دارد. جهت رفع مشکل بر روی دکمه زیر کلیک کنید و یا بخش مودر نظر را حذف نمایید ( قبل از حذف محتویات بخش را به بخش دیگر منتقل کنید)';
$string['deletetile'] = 'حذف بخش';
$string['deleteemptytiles'] = 'حذف بخش های خالی';
$string['scheduleddeleteemptysections'] = 'Task to delete empty sections from course has been scheduled.  Please check back later.';
$string['canceltask'] = 'لغو وظیفه';
$string['problemcoursesintro'] = 'تعداد بخش های دوره های ذیل بیشتر از حد تعیین شده می باشند، جهت رفع مشکل بر روی دکمه زیر کلیک کنید.';
$string['maxcoursesectionsallowed'] = 'حداکثر تعداد بخش های مجاز در هر دوره {$a} می باشد.';
$string['experimentalfeature'] = 'Experimental feature';
$string['problemcourses'] = 'دوره های دارای خطا';
$string['numberofsections'] = 'تعداد بخش در دوره';
$string['highestsectionnum'] = 'Highest section number found';
$string['checkforproblemcourses'] = 'بررسی و بر طرف کردن دوره های دارای خطا';
$string['noproblemsfound'] = 'هیچ مشکلی یافت نشد';
$string['backupfailed'] = 'پشتیبان گیری ناموفق ';
$string['restorefailed'] = 'بازرگدانی ناموفق';
$string['fixproblems'] = 'بر طرف کردن خطا';
