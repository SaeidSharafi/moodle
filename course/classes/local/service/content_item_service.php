...
class content_item_service {
    ...
    public function get_content_items_for_user_in_course(\stdClass $user, \stdClass $course, array $linkparams = [], ?\section_info $sectioninfo = null): array {
        ...
        if ($course->format === 'vums' || $format === "vums"){
            ...
            $filterbysection =[
                ...
                '3' => explode(',',get_config('format_vums', 'section3activitytypes')),
                '4' => explode(',',get_config('format_vums', 'section4activitytypes')),
                '5' => explode(',',get_config('format_vums', 'section5activitytypes')),
                '6' => explode(',',get_config('format_vums', 'section6activitytypes')),
                '7' => explode(',',get_config('format_vums', 'section7activitytypes')),
            ];

            if ($linkparams && isset($linkparams['secid']) && $linkparams['secid'] > 0 && $linkparams['secid'] < 8) {
